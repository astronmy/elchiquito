...
<html lang="en">
	...
	<head>
		...
		<meta name="description" content="Lo mejor de la parrilla mendocina en Las Heras"/>
		<meta name="keywords" content="Parrilla, Las Heras, Mendoza, Restaurant, Restaurant Menu, Costillas, Sandwich, Vacio, Achuras, Entraña, Bebidas">	
		<meta name="viewport" content="width=device-width, initial-scale=1.0"/>
				
  		<!-- SITE TITLE -->
		<title>El Chiquito Parrilla</title>
					...
					<div class="row">	
						<div class="col-lg-10 offset-lg-1">
							<div class="hero-txt text-center white-color">
								<!-- Title -->
								<h2 class="h2-xl">Menú Principal</h2>
							</div>
						</div>	
					</div>	  <!-- End row -->
				</div>	   <!-- End container --> 
							...
							<div class="col-lg-12 text-center">
						 		<ul class="tabs-1 ico-55 red-tabs clearfix">
									...
									<li class="tab-link current" data-tab="tab-1">
										<span class="flaticon-sandwich"></span> 
										<h5 class="h5-sm">Sandwichs</h5>
									</li>
									...
									<li class="tab-link" data-tab="tab-3">
										...
										<h5 class="h5-sm">Fritas</h5>
									</li>

									<!-- TAB-3 LINK -->
									<li class="tab-link" data-tab="tab-4">
										<span class="flaticon-salad-1"></span> 
										<h5 class="h5-sm">Ensaladas</h5>
									</li>

                                    <!-- TAB-3 LINK -->
									<li class="tab-link" data-tab="tab-5">
										<span class="flaticon-beer-1"></span> 
										<h5 class="h5-sm">Bebidas</h5>
									</li>
								...
								<div class="col-sm-6 col-lg-3">
									<div class="menu-7-item">
										...
										<div class="menu-7-img rel">
											...
											<!-- Image -->
											<img class="img-fluid" src="images/menu/burger-01.png" alt="menu-image" />
								...
								<div class="col-sm-6 col-lg-3">
									<div class="menu-7-item">
										...
										<div class="menu-7-img rel">
											...
											<!-- Image -->
											<img class="img-fluid" src="images/menu/burger-02.png" alt="menu-image" />
				...
				<div class="container">
			 		<div class="row">
						...
						<div class="col-lg-10 col-xl-8 offset-lg-1 offset-xl-2">
							<div class="banner-4-txt text-center text-white">

								<!-- Title  -->
								<h4 class="h4-xl">El mejor asado garantizado</h4>
					...
					<div class="row">
						...
						<div class="col-xl-3">
							<div class="footer-info mb-40">
								...
								<!-- Footer Logo -->
								<div class="footer-logo"><img src="images/logo.jpg" alt="footer-logo"/></div>

								<!-- Text -->	
								<p>😋El mejor asado al paso de Las Heras. <br>
                                  🔥Parrillada, Sandwich de Vacío y de Bondiola, Choripan, Pollo y ASADO X KG. <br>
                                   🚶🏼‍♀️Pasas, lo elegis te lo llevas.</p>
						...
						<div class="col-md-6 col-lg-4 col-xl-3">
							<div class="footer-contacts mb-40">
								...
								<!-- Title -->
								<h5 class="h5-sm">Te Esperamos</h5>

								<!-- Address -->
								<p>Patricias Mendocinas y Boulogne Sur Mer</p> 
						...
						<div class="col-md-6 col-lg-6 col-xl-6">
							<div class="footer-info mb-30">
								...
								<!-- Title -->
								<h5 class="h5-sm">Horarios</h5>

								<!-- Text -->
								<p>Los esperamos</p> 

								<!-- Text -->
								<p class="mt-15">Miércoles-Sábado: <span>12:00 - 16:00</span> <span>21:00 a 00:00</span> </p>
								<p>Domingos: <span>12:00 - 16:00</span></p>
						...
						<div class="row d-flex align-items-center">
							...
							<div class="col-md-5 col-lg-6">
								<div class="footer-copyright">
									<p>&copy; 2025 El Chiquito. All Rights Reserved</p>
								</div>
							</div>
							...
							<div class="col-md-7 col-lg-6">
								<ul class="bottom-footer-list text-right clearfix">
									<li><p class="last-li"><a href="https://www.instagram.com/elchiquito.parrilla" target="_blank"><i class="fab fa-instagram"></i> Instagram</a></p></li>
								</ul>
							</div>
